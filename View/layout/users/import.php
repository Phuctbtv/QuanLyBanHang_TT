        ...
        <div class="col-md-9">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="index.php?controller=Users&action=index" class="btn btn-light btn-sm shadow-sm">
                        <i class="bi bi-arrow-left"></i> Quay lại danh sách
                    </a>
                </div>
                
                <div class="card-body p-4">
                    <label for="filePush" class="form-label fw-bold">Chọn file Excel danh sách tài khoản:</label>
                    
                    <form action="index.php?controller=Users&action=import" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="alert alert-danger mt-3">
                            ...
                            <ul class="mb-0 mt-2">
                                ...
                                //     }
                                // }
                            //     foreach ($msgnew as $errorMessage => $rows) {
                            //     echo "<li>";
                            //     echo "<strong>" . $errorMessage . "</strong>: ";
                            //     echo "Dòng " . implode(', ', $rows); 
                            //     echo "</li>";
                            // }
                                foreach ($errors['valid'] as $key => $errorMessage) {
                                    echo "<li>";
                                    echo "<strong>" . $errorMessage['content'] . "</strong>: ";
                                    echo "Dòng " . implode(', ', $errorMessage['row']); 
                                    echo "</li>";
                                }
                                ?>
                            </ul>
